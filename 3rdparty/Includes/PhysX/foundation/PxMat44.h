...
public:
	...
	PX_CUDA_CALLABLE PX_INLINE PxMat44(XMMATRIX const &m) :
		column0(m._11, m._12, m._13, m._14),
		column1(m._21, m._22, m._23, m._24),
		column2(m._31, m._32, m._33, m._34),
		column3(m._41, m._42, m._43, m._44)
	{
	}

	PX_CUDA_CALLABLE PX_FORCE_INLINE operator XMMATRIX()
	{
		return XMMATRIX(
			XMLoadFloat4(&(XMFLOAT4)column0),
			XMLoadFloat4(&(XMFLOAT4)column1),
			XMLoadFloat4(&(XMFLOAT4)column2),
			XMLoadFloat4(&(XMFLOAT4)column3));
	};
